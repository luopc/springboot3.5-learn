...
@Component
public class BankATransactionReader extends JdbcCursorItemReader<BankTransaction> {

    private static final String SQL =
            "SELECT id, transaction_id, bank_name, account_number, amount, transaction_date, description " +
                    "FROM bank_transaction " +
                    "WHERE bank_name = 'BankA'";

    public BankATransactionReader(DataSource dataSource) {
